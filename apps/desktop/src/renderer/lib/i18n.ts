...
import ptBRDataJud from '../locales/pt-BR/datajud.json';
...
import enDataJud from '../locales/en/datajud.json';
...
i18n.use(initReactI18next).init({
  ...
  defaultNS: 'common',
  ns: ['common', 'home', 'settings', 'providers', 'speech', 'status', 'execution', 'tools', 'fallback', 'auth', 'datajud'],
